...
module.exports = function (app) {
    app.get('/:width', function(req, res) {
        req.checkParams('width', 'Must be an integer less than 2000').notEmpty().isInt().lte(2000).gt(0);
    ...
    app.get('/:width/:height', function(req, res) {
        req.checkParams('width', 'Must be an integer less than 2000').notEmpty().isInt().lte(2000).gt(0);
        req.checkParams('height', 'Must be an integer less than 2000').notEmpty().isInt().lte(2000).gt(0);
